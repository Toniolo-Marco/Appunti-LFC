...
\begin{labeling}{Step}
    ...
    \begin{itemize}
        ...
        \item \(r_1\)\(^\ast\) è un’espressione regolare che significa ripetizione di \(r_1\) per un certo numero \(k\) di volte, detta \emph{Kleene star};
...
\begin{itemize}
    ...
    \item \( (0 \mid 1)^\ast 0\) denota l’insieme di tutti i numeri binari pari ( ammettendo numeri con ripetizioni di soli zeri all'inizio );
    \item \( ( 1(0 \mid 1)^\ast 0) \mid 0 \)  denota l’insieme di tutti i numeri binari pari, senza zeri "inutili" all'inizio;
